...
Namespace Global.OpenSilver.Samples.VBShowcase
    Partial Public Class GridSplitter_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/vbsrc/Samples/XAML_Controls/GridSplitter/GridSplitter_Demo.xaml.vb"
    },
                    New ViewSourceButtonInfo() With {
