...
Namespace Global.OpenSilver.Samples.Showcase
    Public Partial Class DropShadowEffect_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/XAML_Features/DropShadowEffect/DropShadowEffect_Demo.xaml.cs"
                    ...
                    New ViewSourceButtonInfo() With {
        .TabHeader = "DropShadowEffect_Demo.xaml.vb",
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/vbsrc/Samples/XAML_Features/DropShadowEffect/DropShadowEffect_Demo.xaml.vb"
    }
})
        End Sub
