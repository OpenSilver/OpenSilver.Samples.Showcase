...
Namespace Global.OpenSilver.Samples.Showcase
    Public Partial Class RenderTransforms_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/XAML_Features/RenderTransforms/RenderTransforms_Demo.xaml.cs"
                    ...
                    New ViewSourceButtonInfo() With {
        .TabHeader = "RenderTransforms_Demo.xaml.vb",
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/vbsrc/Samples/XAML_Features/RenderTransforms/RenderTransforms_Demo.xaml.vb"
    }
})
        End Sub
