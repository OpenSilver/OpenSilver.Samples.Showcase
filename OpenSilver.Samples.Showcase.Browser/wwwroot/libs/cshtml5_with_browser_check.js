...
function CheckBrowserCompatibility() {
    ...
    var isDesktopSafari = /constructor/i.test(window.HTMLElement) || (function (p) { return p.toString() === "[object SafariRemoteNotification]"; })(!window['safari'] || (typeof safari !== 'undefined' && safari.pushNotification));
    ...
    // Chrome 1 - 80
    var isChrome = !!window.chrome && !isIE;
    ...
    if (isFirefox || isEdge || isEdgeChromium || isChrome || isDesktopSafari) {
        return;
    }
    else {
        ...
        alert("This browser is not supported. Please use a browser that supports WebAssembly, such as Microsoft Edge, Google Chrome, or Mozilla Firefox.");
