...
type Plotly_Charts_Demo() as this =
    ...
    member private this.ButtonViewSource_Click(sender : obj, e : RoutedEventArgs) =
        ViewSourceButtonHelper.ViewSource([
            ViewSourceButtonInfo(TabHeader = "Plotly_Charts_Demo.xaml", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Third_Party/Plotly_Charts/Plotly_Charts_Demo.xaml");
            ViewSourceButtonInfo(TabHeader = "Plotly_Charts_Demo.xaml.cs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Third_Party/Plotly_Charts/Plotly_Charts_Demo.xaml.cs");
            ViewSourceButtonInfo(TabHeader = "Plotly_Charts_Demo.xaml.vb", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Third_Party/Plotly_Charts/Plotly_Charts_Demo.xaml.vb");
            ViewSourceButtonInfo(TabHeader = "Plotly_Charts_Demo.xaml.fs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Third_Party/Plotly_Charts/Plotly_Charts_Demo.xaml.fs")
        ])
