...
type IsolatedStorageFile_Demo() as this =
    ...
    member private this.ButtonViewSource_Click(sender : obj, e : RoutedEventArgs) =
        ViewSourceButtonHelper.ViewSource([
            ViewSourceButtonInfo(TabHeader = "IsolatedStorageFile_Demo.xaml", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/IsolatedStorageFile/IsolatedStorageFile_Demo.xaml");
            ViewSourceButtonInfo(TabHeader = "IsolatedStorageFile_Demo.xaml.cs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/IsolatedStorageFile/IsolatedStorageFile_Demo.xaml.cs");
            ViewSourceButtonInfo(TabHeader = "IsolatedStorageFile_Demo.xaml.vb", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/IsolatedStorageFile/IsolatedStorageFile_Demo.xaml.vb");
            ViewSourceButtonInfo(TabHeader = "IsolatedStorageFile_Demo.xaml.fs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/IsolatedStorageFile/IsolatedStorageFile_Demo.xaml.fs")
        ])
