...
type JSON_Serializer_Demo() as this =
    ...
    member private this.ButtonViewSource_Click(sender : obj, e : RoutedEventArgs) =
        ViewSourceButtonHelper.ViewSource([
            ViewSourceButtonInfo(TabHeader = "JSON_Serializer_Demo.xaml", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JSON_Serializer_Demo.xaml");
            ViewSourceButtonInfo(TabHeader = "JSON_Serializer_Demo.xaml.cs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JSON_Serializer_Demo.xaml.cs");
            ViewSourceButtonInfo(TabHeader = "JsonConvert.cs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JsonConvert.cs");
            ViewSourceButtonInfo(TabHeader = "JSON_Serializer_Demo.xaml.vb", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JSON_Serializer_Demo.xaml.vb");
            ViewSourceButtonInfo(TabHeader = "JsonConvert.vb", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JsonConvert.vb");
            ViewSourceButtonInfo(TabHeader = "JSON_Serializer_Demo.xaml.fs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JSON_Serializer_Demo.xaml.fs");
            ViewSourceButtonInfo(TabHeader = "JsonConvert.fs", FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.Showcase/blob/master/src/Samples/Net_Framework/JSON_Serializer/JsonConvert.fs")
        ])
