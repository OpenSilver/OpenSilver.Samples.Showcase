...
Namespace Global.OpenSilver.Samples.Showcase
    Public Module AttachedPropertiesWithMethodToUpdateDom
        ...
        Public ReadOnly AriaLabelProperty As DependencyProperty = DependencyProperty.RegisterAttached(name:="AriaLabel", propertyType:=GetType(String), ownerType:=GetType(AttachedPropertiesWithMethodToUpdateDom), defaultMetadata:=New PropertyMetadata(defaultValue:=Nothing) With {
